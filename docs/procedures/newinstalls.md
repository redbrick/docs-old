...
Since karmic, Ubuntu has decided to do crazy shit with the motd. This is not
...
If you want users to login you'll need to setup the machine to auth off ldap. To
